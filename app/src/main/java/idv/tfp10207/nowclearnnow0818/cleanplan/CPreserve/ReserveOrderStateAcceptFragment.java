...
public class ReserveOrderStateAcceptFragment extends Fragment {
    ...
    private void showOrders() {
        ReserveOrderStateAcceptFragment.OrderAdapter orderAdapter = (ReserveOrderStateAcceptFragment.OrderAdapter) rv_reserveorder_accept_11.getAdapter();
        if (orderAdapter == null) {
            orderAdapter = new ReserveOrderStateAcceptFragment.OrderAdapter();
    ...
    private static class OrderAdapter extends RecyclerView.Adapter<ReserveOrderStateAcceptFragment.OrderAdapter.MyOrderViewHolder> {
        private List<Cpreserveorder> cpreserveorders;
