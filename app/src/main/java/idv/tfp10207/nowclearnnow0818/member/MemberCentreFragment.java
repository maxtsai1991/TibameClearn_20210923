...
//            bundle.putSerializable("users", (Serializable) materials);
...
//        final Material spot = materials.get(position);
...
//        // 點選會開啟修改頁面
//        iv_clear1_01.setOnClickListener(v -> {
//            Bundle bundle = new Bundle();
//            bundle.putSerializable("users", materials);
